                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                        <div class="md:w-1/2">
                            ...
                            <div class="swiper-container">
                                ...
                                <!-- Slides -->
                                {{-- <div class="swiper-slide"><img src="{{ asset('storage/products/sample2.jpg') }}" alt=""></div> --}}
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <h2 class="mb-4 text-gray-900 text-3xl title-font font-medium">{{ $product->name }}</h2>
                            ...
                            <div class="flex justify-around items-center">
                                ...
                                <div>
                                    <div><span class="mr-3">数量</span></div>
                                    <div class="relative">
                    ...
                    <div class="border-t border-gray-400 my-8">
                        ...
                        <div class="mb-4 text-center">
                            ...
                            @else
                                <img class="w-40 h-40 rounded-full" src="" alt="">
                            @endif
                        </div>
                        <div class="mb-4 text-center">
                            <button data-micromodal-trigger="modal-1" href="j'javascript:;" type="button" class="text-white bg-indigo-400 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-500 rounded">ショップの詳細を見る</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
            ...
            <footer class="modal__footer">
              <button type="button" class="modal__btn" data-micromodal-close aria-label="Close this dialog window">とじる</button>
            </footer>
          </div>
        </div>
      </div>
